...
let housingDataState = dl.csv('https://raw.githubusercontent.com/lkilduff/lkilduff.github.io/main/data/housingDataState.csv');
let housingDataStateYearly = dl.csv('https://raw.githubusercontent.com/lkilduff/lkilduff.github.io/main/data/housingDataStateYearly.csv');
let lifeData = dl.csv('https://raw.githubusercontent.com/lkilduff/lkilduff.github.io/main/data/lifeexpt1959_2019_v2.csv');
let policyData = dl.csv('https://raw.githubusercontent.com/lkilduff/lkilduff.github.io/main/data/NIAPolicyChange.csv')
...
let line = Highcharts.chart('line', {
    ...
    title: {
      ...
      accessibility: {
        rangeDescription: 'Range: 1959 to 2019'
      },
      tickInterval: 10
    },
    legend: {
    ...
    series: [{
        name: "Oklahoma",
        data:  [71.13,	70.79,	71.15,	71,	70.92,	71.16,	71.65,	71.27,	71.42,	71.26,	71.25,	71.06,	71.94,	71.67,	71.91,	72.11,	72.37,	72.66,	73.2,	72.99,	73.51,	73.58,	73.77,	73.69,	74.3,	74.58,	74.54,	74.62,	75.05,	74.88,	75.12,	74.97,	75.1,	75.25,	74.71,	74.84,	74.88,	75.06,	74.96,	75.15,	75.02,	75.03,	75.3,	75.06,	75.07,	75.45,	75.06,	75.38,	75.3,	75.14,	75.64,	75.7,	75.68,	75.89,	75.67,	75.75,	75.68,	75.8,	75.76,	75.93,	76.09],
        color: '#e60707'                       
        },
        {
        name: "Connecticut",
        data: [ 71.09,	71.05,	71.41,	71.11,	70.99,	71.48,	71.44,	71.47,	71.73,	71.64,	72.18,	72.57,	72.9,	72.99,	73.22,	73.65,	74.02,	74.31,	74.73,	74.89,	75.18,	74.93,	75.39,	75.6,	75.9,	75.86,	75.91,	76.11,	76.26,	76.28,	76.47,	77.12,	77.19,	77.32,	77.08,	77.02,	77.3,	77.57,	77.92,	78.03,	78.44,	78.25,	78.61,	78.72,	79.09,	79.35,	79.51,	79.69,	80.05,	80.26,	80.5,	80.69,	80.69,	80.87,	80.94,	81.08,	80.81,	80.85,	80.69,	80.86,	80.76],
        color: '#084081'
    }]
...
let rentProps = {
    ...
    title: {
        text: 'Policy Liberalization Score'
    },
    ...
    subtitle: {
        ...
        colorAxis: {
            dataClasses: [{
                to: -0.1729664,
                color: '#e60707', // #e60707 light red
                name: 'Became much more conservative',
            }, {
                from: -0.1729664,
                to: .0,
                color: '#f74f4f', // #f74f4f dark red
                name: 'Became somewhat more conservative',
            }, {
                from: 0,
                to: 0.1729664,
                color: '#2b8cbe', // #2b8cbe light blue
                name: 'Became somewhat more liberal',
            }, {
                from: 0.1729664,
                color: '#084081', // #084081 dark blue
                name: 'Became much more liberal',
            }]
        },
    ...
    legend: {
        title: {
            text: "Policy Liberalization by State"
        }
    },
    series: [{
        data: data,
